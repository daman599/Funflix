...
export function MovieList({ poster_path, title, tmdb_id }) {
    ...
    return (
        <Link to={`/movie-details/${tmdb_id}`} className="no-underline text-inherit">
            <div className="relative z-10 w-44 h-[320px] sm:w-48 md:w-52 lg:w-56 cursor-pointer bg-blue-950/50 rounded-2xl overflow-hidden shadow-md 
                            hover:scale-105 hover:shadow-lg hover:shadow-blue-500 transition-all duration-300 ease-in-out">
